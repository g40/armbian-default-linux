...
#define ISP_CTL1_FLAGS 0xA3. // N.B. Also 0x83 in use
#endif
...
static struct regval_list sensor_default_regs[] = {
    ...
    { ISP_CTL1,ISP_CTL1_FLAGS}, // ISP Control 1{0x5001, 0xa3},
...
static struct regval_list sensor_qsxga_7FPS_regs[] = {
    ...
    { ISP_CTL1,ISP_CTL1_FLAGS}, // {0x5001, 0xa3},             //ISP effect    
...
static struct regval_list sensor_1080p_120FPS_regs[] = {
  ...
  {0x4407, 0x04},
    ...
    { ISP_CTL1,ISP_CTL1_FLAGS}, // {0x5001, 0x83},
